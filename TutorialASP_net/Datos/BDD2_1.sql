...
-- Volcando datos para la tabla mvctutorial.mensajes: 21 rows
...
INSERT INTO `mensajes` (`userid`, `mensaje`, `idmsg`, `datemsg`) VALUES
	...
	(1, '1', 68, '2022-08-15 13:52:42'),
	(2, '1', 67, '2022-08-15 13:52:27'),
	(2, 'd', 66, '2022-08-15 13:52:03'),
	(1, 'h', 65, '2022-08-15 13:51:36'),
	...
	(1, '1', 69, '2022-08-15 13:55:26'),
	(1, '123', 70, '2022-08-15 13:55:41');
...
INSERT INTO `siteuser` (`userid`, `username`, `email`, `password`, `profile_img`, `roleid`, `lastLogin`) VALUES
	(1, 'refu23', 'refu@mail.com', '12345', '/static/img/user/1/profile/casa-kame-de-dragon-ball_3840x2160_xtrafondos.com (1).jpg', 1, '2022-08-15 13:55:18'),
	(2, 'a', 'refu1@mail.com', '12345', '/static/img/no_user.png', 1, '2022-08-15 13:51:51'),
	(3, 'b', 'correo@mail.com', '12345', '/static/img/no_user.png', 3, '2022-08-12 09:39:27'),
	(4, 'c', 'jose@mail.com', '12345', '/static/img/no_user.png', 1, '2022-08-12 09:21:35');
